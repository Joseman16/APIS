...
public partial class BaseErpContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Name=BaseERP");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CiudadId).HasName("PK__CIUDAD__AA0ADB67A23E90AF");
        ...
        {
            entity.HasKey(e => e.ClienteId).HasName("PK__CLIENTE__47E34D64FDB3A124");
        ...
        {
            entity.HasKey(e => e.FpagoId).HasName("PK__FORMA_PA__5507F787E85D053A");
        ...
        {
            entity.HasKey(e => e.IndustriaId).HasName("PK__INDUSTRI__8558EAC610B4C300");
        ...
        {
            entity.HasKey(e => e.ModuloId).HasName("PK__MODULO__372E6251ED3FCD7F");
        ...
        {
            entity.HasKey(e => e.MovicabId).HasName("PK__MOVIMIEN__57E1745CF64FFB98");
        ...
        {
            entity.HasKey(e => e.MovidetPagoId).HasName("PK__MOVIMIEN__4EA9F6FA8F8F01FC");
        ...
        {
            entity.HasKey(e => e.MovidetProdId).HasName("PK__MOVIMIEN__39F20EB4E93F81D2");
        ...
        {
            entity.HasKey(e => e.OpcionId).HasName("PK__OPCION__FFA6A8F847EECED5");
        ...
        {
            entity.HasKey(e => e.PaisId).HasName("PK__PAIS__C050735E1B787271");
        ...
        {
            entity.HasKey(e => e.ProvId).HasName("PK__PROVEEDO__435F5326F64BDE82");
        ...
        {
            entity.HasKey(e => e.PuntoEmisionId).HasName("PK__PUNTO_EM__68CB08A336B5FE70");
        ...
        {
            entity.HasKey(e => e.RolId).HasName("PK__ROL__CF32E4433E1FF064");
        ...
        {
            entity.HasKey(e => e.StockId).HasName("PK__STOCK__E8666862D106D30A");
        ...
        {
            entity.HasKey(e => e.TarjetacredId).HasName("PK__TARJETA___09F7CCDFE8D24F7B");
        ...
        {
            entity.HasKey(e => e.TipomovId).HasName("PK__TIPO_MOV__C1580516817B36E1");
        ...
        {
            entity.HasKey(e => e.UsuId).HasName("PK__USUARIO__430A673CF73AE452");
        ...
        {
            entity.HasKey(e => e.PermisoId).HasName("PK_USUARIO_PERMISO");
            ...
            entity.HasOne(d => d.Usuario).WithMany(p => p.UsuarioPermisos)
                ...
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("fk_usu_perm_usuario");

            entity.HasOne(d => d.Opcion).WithMany(p => p.UsuarioPermisos)
                .HasForeignKey(d => d.OpcionId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("fk_usu_perm_opcion");
        });

        modelBuilder.Entity<UsuarioRol>(entity =>
        {
            entity.HasKey(e => e.UsuRolId).HasName("PK_USUARIO_ROL");
            ...
            entity.HasOne(d => d.Usuario).WithMany(p => p.UsuarioRols)
                .HasForeignKey(d => d.UsuId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("fk_usu_rol_usuario");

            entity.HasOne(d => d.Rol).WithMany(p => p.UsuarioRols)
                .HasForeignKey(d => d.RolId)
                .OnDelete(DeleteBehavior.Cascade)
                .HasConstraintName("fk_usu_rol_rol");
        });
